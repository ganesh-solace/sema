            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                     <div class="row add-code-row">
                         <?php
                         $BrandCodeAttr = array( 'name' => 'BrandCode[]','id' => 'BrandCode','class'=> "form-control input-count", "status" => 1);
...
        $( '#SemaClassList').multiselect({
       ...
       function generateHTMLString( InputValue,flag,CodeID ) {
        ...
        $("#FormSubmit").click(function( e ) {     
            ...
            e.preventDefault();
            var FormData = {   Name : $('#BrandName').val(), BrandCode: $("input[name='BrandCode[]']").val()   };
                var flag = false;
                $.ajax({
